...
* </pre>
 */
package com.iqb.consumer.carthree.front.carthree;
...
import com.iqb.eatep.ec.util.HttpClientUtil;
...
public class TestCheThreeController {
    ...
    private static final String BASEURL = "http://localhost:8080/consumer.carthree.front/unIntcpt-cheThreeHunder";
    ...
    public void carThreeFixPrice() throws Exception {
         ...
         * 新出参 {"eval_prices":{"b2b_price":6.16,//批发价"c2b_price":6.01//收车价
         * ,"b2c_price":7.66},"status":"1"}
         * 
         */
    }
    ...
    @Test
    public void carThreeNewCarPrice1() throws Exception {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("oper", "exportModel");// 车300车型ID
        String json = JSON.toJSONString(params);
        logger.info("请求数据:{}", json);
        String result = HttpClientUtil.httpPost(BASEURL + "/carThreeMonthlyYearResidual1", json);
        logger.info("返回结果:{}", result);
        /**
         * 出参 { "status": 1,//0表示失败 1表示成功 "new_car_price": { "price": "41.38",//新车最低价 "code": 1,
         * "avg_price": "41.38",//平均优惠价 "dealer_name": "南京永达奥迪",//4S店名称 "report_date":
