...
public class ManageCarInfoBean {
    ...
    public int getClearCarloanFlag() {
        return clearCarloanFlag;
    }

    public void setClearCarloanFlag(int clearCarloanFlag) {
        this.clearCarloanFlag = clearCarloanFlag;
    }
