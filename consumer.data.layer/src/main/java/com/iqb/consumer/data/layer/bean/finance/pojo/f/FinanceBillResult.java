...
public class FinanceBillResult {
    private int currentPage; // 当前页
    private int numPerPage; // 每页显示多少条

    // 查询数据库
    private int totalCount; // 总记录数
    private List<FinanceBillPojo> recordList; // 本页的数据列表
    ...
    public List<FinanceBillPojo> getRecordList() {
        return recordList;
    }

    public void setRecordList(List<FinanceBillPojo> recordList) {
