...
public class OrderBean extends BaseEntity {
    ...
    private BigDecimal receivedPreAmt; // 已支付的预付款
    private BigDecimal caculateAmt; // preAmt - receivedPreAmt
    ...
    private int backFlag; // 蒲公英行流程退回标识 0 未返回 1 返回
    ...
    private String finalRiskAdvice;// 风控终审意见
    ...
    private int importFlag;// 订单导入标志 1是 2否
    private String payOwnerId;
    private Date stageDate;// 分期时间
    private int leftInstIMonth;
    private int leftInstIDay;
    ...
    public BigDecimal getCaculateAmt() {
        return caculateAmt;
    }

    public void setCaculateAmt(BigDecimal caculateAmt) {
        this.caculateAmt = caculateAmt;
    }
    ...
    public int getLeftInstIMonth() {
        return leftInstIMonth;
    }

    public void setLeftInstIMonth(int leftInstIMonth) {
        this.leftInstIMonth = leftInstIMonth;
    }

    public int getLeftInstIDay() {
        return leftInstIDay;
    }

    public void setLeftInstIDay(int leftInstIDay) {
