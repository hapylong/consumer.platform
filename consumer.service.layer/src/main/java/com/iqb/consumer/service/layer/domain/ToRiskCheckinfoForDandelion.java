 ...
 * 
 * NAME : ToRiskCheckinfoForDandelion.java
 * 
 * PURPOSE :
 * 
 * AUTHOR : crw
 ...
 * 
 */
public class ToRiskCheckinfoForDandelion {
    ...
    @JsonProperty("colleagues1")
    private String colleagues1;

    @JsonProperty("colleagues2")
    ...
    @JsonProperty("relation2")
    private String relation2;

    @JsonProperty("relation3")
