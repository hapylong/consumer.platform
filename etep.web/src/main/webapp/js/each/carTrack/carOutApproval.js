...
$package('IQB.carOutApproval');
IQB.carOutApproval = function() {
    var _this = {
        cache: {
        	viewer: {}
        },
		...
		openApproveWin: function(){
			if($('#lostContactReason').val() == ''){
				IQB.alert('失去联系原因为空，无法审核');
				return false;
			}
			var data = {
        ...
        init: function(){       
            ...
            IQB.getDictListByDictType('trailerReason', 'car_back_reason');
