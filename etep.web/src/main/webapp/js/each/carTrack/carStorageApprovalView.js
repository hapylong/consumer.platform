...
$package('IQB.carStorageApprovalView');
IQB.carStorageApprovalView = function() {
    var _this = {
        cache: {
        	viewer: {}
        },
        ...
        showHtml: function() {
            ...
            IQB.post(urls['cfm'] + '/carstatus/cget_info' , data,function(result){
                ...
                $('#intoGarageDate').text(Formatter.timeCfm2(result.iqbResult.result.intoGarageDate));
            });
        },
...
$(function() {
	//页面初始化
    IQB.carStorageApprovalView.init();
});
