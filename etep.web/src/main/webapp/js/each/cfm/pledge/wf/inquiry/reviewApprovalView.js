...
$package('IQB.reviewApprovalView');
IQB.reviewApprovalView = function() {
	var _this = {
		cache:{
			viewer: {}
		},
		...
		initFrom : function(){
			...
			IQB.post(_this.config.getById, option, function(result){
				...
				$('#applyAmt').text(Formatter.moneyTs(parseFloat(resl.applyAmt)/10000));
