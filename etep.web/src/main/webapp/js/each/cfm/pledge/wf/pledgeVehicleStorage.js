...
$package('IQB.pledgeVehicleStorage');
IQB.pledgeVehicleStorage = function(){
	var _this = {
		cache: {			
			viewer: {}
		},	
		...
		openApproveWin: function() {
			...
			_this.saveVehicleStorageInfo();
		},
		saveVehicleStorageInfo: function(){
			/** 保存质押车车辆入库信息 **/
			var rfid = $("#rfid").val();
...
//				$('#applyAmt').text(Formatter.money(result.applyAmt));
				...
				$('#remark').val((Formatter.ifNull(result.ipiRemark)));
