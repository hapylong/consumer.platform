		...
		check : function(){
			$("#btn-supplement").click(function(){
				...
				if(_grid.util.checkSelectOne(records)){			    	
					...
					//跳转窗口
					window.parent.IQB.main2.openTab("activiti-customerFollow", "补充资料", encodeURI('/etep.web/view/crm/customer/customerFollowDetail.html?merchantShortName=' + records[0].merchantShortName + '&realName=' + records[0].realName + '&regId=' + records[0].regId + '&orderId=' + records[0].orderId + '&smsMobile=' + records[0].smsMobile), true, true, {lastTab: param});
				}
			})
		},
