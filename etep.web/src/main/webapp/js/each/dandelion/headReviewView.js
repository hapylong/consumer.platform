...
$package('IQB.headReviewView');
IQB.headReviewView = function(){
	var _this = {
		cache: {
			viewer: {},
			i:1,
		...
		BondsmanNo : function(){
			IQB.post(urls['cfm'] + '/dandelion/get_designated_person_info', {'orderId':window.procBizId}, function(result){
				var num = result.iqbResult.result.icie.guarantorNum;
				switch (num)
				{
				case 2:
					$('.bondsmanInfo-2').show();
