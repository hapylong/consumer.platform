$package('IQB.waitHandle');
IQB.waitHandle = function() {
	var _box = null;
	var _list = null;
	var _this = {
		//签收
		...
		config : {
			action : {
				...
				unassign : urls['rootUrl'] + '/WfTask/unclaimProcess',// 释放
				delegate : urls['rootUrl'] + '/WfTask/delegateProcess',// 委托
				approve : urls['rootUrl'] + '/WfTask/completeProcess',
