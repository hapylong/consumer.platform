...
$package('IQB.carLoanContractAuditView');
IQB.carLoanContractAuditView = function() {
    var _this = {
        cache: {
        	viewer: {}
        }, 
        ...
        showHtml: function() {
        	...
        	IQB.post(urls['cfm'] + '/ownerloan/getCarinfo' , data,function(result){
            	...
            	$('#firstBuyAmt').text(Formatter.isNull(result.firstBuyAmt)); 
...
$(function() {
	//页面初始化
    IQB.carLoanContractAuditView.init();
});