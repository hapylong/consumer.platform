...
IQB.stageOrder = function(){
	...
	var _this = {
		...
		config: {
			action: {//页面请求参数
				exports: urls['cfm'] + '/carOwner/exportOrderBreakInfo',
				stage: urls['cfm'] + '/carOwner/orderBreak'
  			},
			event: {//按钮绑定函数，不定义的话采用默认
				...
				search:function(){
					...
					$("#datagrid").datagrid2
							({
							 url: urls['cfm'] + '/carOwner/getOrderBreakInfo',
							 queryParams : 
		...
		exports : function(){
			$("#btn-export").click(function(){
				...
				var datas = "?&merchNames=" + merchName + "&regId=" + regId + "&userName=" + userName + "&orderId=" + orderId + "&startTime=" + startTime + "&endTime=" + endTime;
